...
class LinearRegression:
    ...
    def fit_gd(self, X_train, y_train, eta=0.01, n_iters=1e4, episilon=1e-8):
        ...
        def gradient_descent(X_b, y, initial_theta, eta, n_iters=1e4, episilon=1e-8):
            theta = initial_theta
            cur_iter = 0
        ...
        self._theta = gradient_descent(X_b, y_train, initial_theta, eta, n_iters, episilon)
        ...
        def sgd(X_b, y, initial_theta, n_iters=5, t0=5, t1=50):
            ...
            for cur_iter in range(n_iters):
                ...
                for i in range(m):
                    ...
                    theta = theta - learnibg_rate(cur_iter * m + i) * gradient
